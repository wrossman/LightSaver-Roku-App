...
sub launchDialog()
    ...
    m.dialog.title = ["Lightroom Album Error"]
    m.dialog.message = ["Album selected is empty or does not have any images. Please try again after adding images to your album."]
